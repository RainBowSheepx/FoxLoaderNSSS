...
public class DependencyHelper {
    ...
    public static final Dependency[] clientDependencies = new Dependency[]{
            new Dependency("com.dirtpiper:nsss:" + BuildConfig.NSSS_VERSION,
                    BuildConfig.CLIENT_NSSS_URL, "com.mojang.minecraft.Timer",
                    null, BuildConfig.CLIENT_NSSS_SHA256_SUM)
    };
