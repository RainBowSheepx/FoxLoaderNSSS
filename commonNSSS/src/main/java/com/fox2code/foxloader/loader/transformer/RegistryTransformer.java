...
public class RegistryTransformer implements PreClassTransformer {
    ...
    private static final String BLOCK_CLS = "com.mojang.minecraft.level.tile.Block";
    ...
    private static final String BLOCK = "com/mojang/minecraft/level/tile/Block";
    private static final String ITEM = "com/mojang/minecraft/entity/item/Item";
   ...
   //     int blockCap = /*TransformerUtils.getField(classNode, "blockcap")*/;
